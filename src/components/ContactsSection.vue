    ...
    <div class="container section-inner">
      <header class="contacts__head">
        ...
        <h2 class="section-title reveal reveal--delay-1">
          Найдите нас<br /><em>в&nbsp;центре Иваново</em>
        </h2>
      </header>
      ...
      <div class="contacts__map reveal reveal--scale">
